...
//                                    ClientMain.processing = false;
                            ...
                            case "!!proc":{
                                if(cmd0.length<2){
                                    com.ghostj.client_old.ClientMain.bufferedWriter.write("proc命令语法不正确.\n");
                                    com.ghostj.client_old.ClientMain.bufferedWriter.flush();
                                    com.ghostj.client_old.ClientMain.sendFinishToServer();
                                    continue;
                                }
                                switch (cmd0[1]){
                                    case "focus":{
                                        if(cmd0.length<3){
                                            com.ghostj.client_old.ClientMain.bufferedWriter.write("proc focus命令语法不正确.\n");
                                            com.ghostj.client_old.ClientMain.bufferedWriter.flush();
                                            com.ghostj.client_old.ClientMain.sendFinishToServer();
                                            continue;
                                        }
                                        for(String key: com.ghostj.client_old.ClientMain.processList.keySet()){
                                            if(key.startsWith(cmd0[2])){
                                                com.ghostj.client_old.ClientMain.focusedProcess= com.ghostj.client_old.ClientMain.processList.get(key);
                                                com.ghostj.client_old.ClientMain.bufferedWriter.write("聚焦process:"+key+"\n");
                                                com.ghostj.client_old.ClientMain.bufferedWriter.flush();
                                                com.ghostj.client_old.ClientMain.sendFinishToServer();
                                                continue readMsg;
                                            }
                                        }
                                        com.ghostj.client_old.ClientMain.bufferedWriter.write("找不到"+cmd0[2]+"开头的process\n");
                                        com.ghostj.client_old.ClientMain.bufferedWriter.flush();
                                        com.ghostj.client_old.ClientMain.sendFinishToServer();
                                        continue;
                                    ...
                                    case "ls":{
                                        new Thread(()-> {
                                            try {
                                                com.ghostj.client_old.ClientMain.bufferedWriter.write("列表所有此客户端已连接的process(" + com.ghostj.client_old.ClientMain.processList.size() + ")\nkey\tinitCmd\tstartTime\tstate\n");
                                                com.ghostj.client_old.ClientMain.bufferedWriter.flush();
                                                for (String key : com.ghostj.client_old.ClientMain.processList.keySet()) {
                                                    com.ghostj.client_old.ClientMain.bufferedWriter.write(key + "      " + com.ghostj.client_old.ClientMain.processList.get(key).cmd + "         "
                                                            + TimeUtil.millsToMMDDHHmmSS(com.ghostj.client_old.ClientMain.processList.get(key).startTime) + "   " + (com.ghostj.client_old.ClientMain.focusedProcess == com.ghostj.client_old.ClientMain.processList.get(key)) + "\n");
                                                }
                                                com.ghostj.client_old.ClientMain.bufferedWriter.write("列表完成.\n");
                                                com.ghostj.client_old.ClientMain.bufferedWriter.flush();
                                                com.ghostj.client_old.ClientMain.sendFinishToServer();
                                            } catch (Exception e) {
                                                e.printStackTrace();
                                    ...
                                    case "new":{
                                        if(cmd0.length<3){
                                            com.ghostj.client_old.ClientMain.bufferedWriter.write("proc new命令语法不正确.\n");
                                            com.ghostj.client_old.ClientMain.bufferedWriter.flush();
                                            com.ghostj.client_old.ClientMain.sendFinishToServer();
                                            continue;
                                        }
                                        com.ghostj.client_old.ClientMain.bufferedWriter.write("新建进程:"+cmd0[2]+"\n");
                                        if(cmd0.length>=4){//如果有初始执行指令
                                            com.ghostj.client_old.ProcessCmd processCmd = new com.ghostj.client_old.ProcessCmd(cmd0[2]);
                                            processCmd.cmd = cmd0[3];
                                            com.ghostj.client_old.ClientMain.processList.put(cmd0[2],processCmd);
                                            processCmd.start();
                                            com.ghostj.client_old.ClientMain.sendFinishToServer();
                                        }else {
                                            com.ghostj.client_old.ProcessCmd processCmd = new com.ghostj.client_old.ProcessCmd(cmd0[2]);
                                        ...
                                        com.ghostj.client_old.ClientMain.focusedProcess= com.ghostj.client_old.ClientMain.processList.get(cmd0[2]);
                                        com.ghostj.client_old.ClientMain.bufferedWriter.write("聚焦process:"+cmd0[2]+"\n");
                                        com.ghostj.client_old.ClientMain.bufferedWriter.flush();
                                        continue;
                                    }
                                    case "disc":{
                                        if(cmd0.length<3){
                                            com.ghostj.client_old.ClientMain.bufferedWriter.write("proc disc命令语法不正确.\n");
                                            com.ghostj.client_old.ClientMain.bufferedWriter.flush();
                                            com.ghostj.client_old.ClientMain.sendFinishToServer();
                                            continue;
                                        }
                                        //注意！！这里仅仅是断开与进程的连接而不是结束进程
                                        if(com.ghostj.client_old.ClientMain.processList.containsKey(cmd0[2])){
                                            try {
                                                com.ghostj.client_old.ClientMain.processList.get(cmd0[2]).process.destroy();
                                                com.ghostj.client_old.ClientMain.removeProcess(cmd0[2]);
                                            }catch (Exception e){
                                                com.ghostj.client_old.ClientMain.bufferedWriter.write("断连process时出现错误\n"+getErrorInfo(e));
                                                com.ghostj.client_old.ClientMain.bufferedWriter.flush();
                                            }
                                        }else {
                                            com.ghostj.client_old.ClientMain.bufferedWriter.write("仅能使用全名来断连process\n");
                                            com.ghostj.client_old.ClientMain.bufferedWriter.flush();
                                        }
                                        com.ghostj.client_old.ClientMain.sendFinishToServer();
                                        continue;
